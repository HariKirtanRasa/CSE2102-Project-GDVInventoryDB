...
if(isset($_POST['search'])){
 $valueToSearch = $_POST['valueToSearch'];
  $query = "SELECT * FROM `Suppliers` WHERE CONCAT(`Supplier_ID`, `Name`, `Email`, `Note`, `Address`, `Contact`) LIKE '%".$valueToSearch."%'";
...
if(isset($_POST['save'])){
 $sql = "UPDATE Suppliers SET Supplier_ID = '$_POST[Supplier_ID]', Name = '$_POST[Name]', Email = '$_POST[Email]', Note = '$_POST[Note]', Address = '$_POST[Address]', Contact = '$_POST[Contact]' WHERE Supplier_ID = '$_POST[Supplier_ID]'";
  $connect = mysqli_connect("localhost", "root", "", "exercise");
   if(mysqli_query($connect, $sql)){
    header("location: update_supplier.php");     }     }
    elseif(isset($_POST['cancel'])){
      header("location: update_supplier.php");       }

if(isset($_POST['Delete'])){
 $sql = "DELETE FROM Suppliers WHERE Supplier_ID = '$_POST[Supplier_ID]' LIMIT 1";
  $connect = mysqli_connect("localhost", "root", "", "exercise");
   if(mysqli_query($connect, $sql)){
    header("location: update_supplier.php");     }     }
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li class="active" data-toggle="dropdown"><a href="#">☰ GDVInventory</a></li>
        ...
        <li><a href="list_suppliers.php">Search Supplier</a></li>
  ...
  <table class="table table-striped">
    ...
    <form action="update_supplier.php" method="post">
            ...
            <?php while($row = mysqli_fetch_array($search_result)){
               echo "<tr>";
                echo "<td><input type = text class = form-control autocomplete = off name = Supplier_ID value ='" .$row['Supplier_ID']. "'></td>";
                echo "<td><input type = text class = form-control autocomplete = off name = Name value ='" .$row['Name']. "'></td>";
                echo "<td><input type = text class = form-control autocomplete = off name = Email value ='" .$row['Email']. "'></td>";
                echo "<td><input type = text class = form-control autocomplete = off name = Note value ='" .$row['Note']. "'></td>";
                echo "<td><input type = text class = form-control autocomplete = off name = Address value ='" .$row['Address']. "'></td>";
